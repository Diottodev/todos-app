  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 h-0.5 w-full overflow-hidden opacity-0 transition-opacity duration-300 group-hover:opacity-100">
        <div className="group-hover:-translate-x-[200%] h-full w-1/2 translate-x-full transform bg-gradient-to-r from-transparent via-primary to-transparent transition-transform delay-100 duration-3000 ease-out" />
      </div>
      ...
      <div className="absolute top-0 left-0 h-full w-0.5 overflow-hidden opacity-0 transition-opacity duration-300 group-hover:opacity-100">
        <div className="-translate-y-full h-1/2 w-full transform bg-gradient-to-b from-transparent via-primary to-transparent transition-transform delay-50 duration-3000 ease-out group-hover:translate-y-[200%]" />
      </div>
